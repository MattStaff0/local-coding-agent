...
Out[69]: <pandas.api.typing.SeriesGroupBy object at 0x7fd329045b50>
```
...
natural and functions similarly to [`itertools.groupby()`](https://docs.python.org/3/library/itertools.html#itertools.groupby "(in Python v3.14)"):
...
[`DataFrameGroupBy.get_group()`](../reference/api/pandas.api.typing.DataFrameGroupBy.get_group.html#pandas.api.typing.DataFrameGroupBy.get_group "pandas.api.typing.DataFrameGroupBy.get_group"):
...
While the [`DataFrameGroupBy.describe()`](../reference/api/pandas.api.typing.DataFrameGroupBy.describe.html#pandas.api.typing.DataFrameGroupBy.describe "pandas.api.typing.DataFrameGroupBy.describe") method is not itself a reducer, it
...
This is similar to the [`DataFrameGroupBy.value_counts()`](../reference/api/pandas.api.typing.DataFrameGroupBy.value_counts.html#pandas.api.typing.DataFrameGroupBy.value_counts "pandas.api.typing.DataFrameGroupBy.value_counts") function, except that it only counts the
...
The [`aggregate()`](../reference/api/pandas.api.typing.DataFrameGroupBy.aggregate.html#pandas.api.typing.DataFrameGroupBy.aggregate "pandas.api.typing.DataFrameGroupBy.aggregate") method can accept many different types of
...
[`aggregate()`](../reference/api/pandas.api.typing.DataFrameGroupBy.aggregate.html#pandas.api.typing.DataFrameGroupBy.aggregate "pandas.api.typing.DataFrameGroupBy.aggregate"). Users are encouraged to use the shorthand,
...
provided `Series`. See [Mutating with User Defined Function (UDF) methods](gotchas.html#gotchas-udf-mutation) for more information.
...
as the one being grouped. Common examples include [`cumsum()`](../reference/api/pandas.api.typing.DataFrameGroupBy.cumsum.html#pandas.api.typing.DataFrameGroupBy.cumsum "pandas.api.typing.DataFrameGroupBy.cumsum") and
[`diff()`](../reference/api/pandas.api.typing.DataFrameGroupBy.diff.html#pandas.api.typing.DataFrameGroupBy.diff "pandas.api.typing.DataFrameGroupBy.diff").
...
[`transform()`](../reference/api/pandas.api.typing.DataFrameGroupBy.transform.html#pandas.api.typing.DataFrameGroupBy.transform "pandas.api.typing.DataFrameGroupBy.transform") (see the next section) will broadcast the result
...
[`transform()`](../reference/api/pandas.api.typing.DataFrameGroupBy.transform.html#pandas.api.typing.DataFrameGroupBy.transform "pandas.api.typing.DataFrameGroupBy.transform") method can accept string aliases to the built-in
...
In addition to string aliases, the [`transform()`](../reference/api/pandas.api.typing.DataFrameGroupBy.transform.html#pandas.api.typing.DataFrameGroupBy.transform "pandas.api.typing.DataFrameGroupBy.transform") method can
...
To select the nth item from each group, use [`DataFrameGroupBy.nth()`](../reference/api/pandas.api.typing.DataFrameGroupBy.nth.html#pandas.api.typing.DataFrameGroupBy.nth "pandas.api.typing.DataFrameGroupBy.nth") or
[`SeriesGroupBy.nth()`](../reference/api/pandas.api.typing.SeriesGroupBy.nth.html#pandas.api.typing.SeriesGroupBy.nth "pandas.api.typing.SeriesGroupBy.nth"). Arguments supplied can be any integer, lists of integers,
...
[`DataFrameGroupBy.ngroup()`](../reference/api/pandas.api.typing.DataFrameGroupBy.ngroup.html#pandas.api.typing.DataFrameGroupBy.ngroup "pandas.api.typing.DataFrameGroupBy.ngroup").
...
By using [`DataFrameGroupBy.ngroup()`](../reference/api/pandas.api.typing.DataFrameGroupBy.ngroup.html#pandas.api.typing.DataFrameGroupBy.ngroup "pandas.api.typing.DataFrameGroupBy.ngroup"), we can extract
