...
The [list](../library/stdtypes.html#typesseq-list) data type has some more methods. Here are all
...
item to the top of the stack, use [`append()`](../library/stdtypes.html#list.append "list.append"). To retrieve an item from the
top of the stack, use [`pop()`](../library/stdtypes.html#list.pop "list.pop") without an explicit index. For example:
...
value: the [`del`](../reference/simple_stmts.html#del) statement. This differs from the [`pop()`](../library/stdtypes.html#list.pop "list.pop") method
...
Python also includes a data type for [sets](../library/stdtypes.html#types-set). A set is
...
assignments, slice assignments, or methods like [`append()`](../library/stdtypes.html#list.append "list.append") and
[`extend()`](../library/stdtypes.html#list.extend "list.extend").
...
[`KeyError`](../library/exceptions.html#KeyError "KeyError"). To avoid getting this error when trying to access a possibly
non-existent key, use the [`get()`](../library/stdtypes.html#dict.get "dict.get") method instead, which returns
...
[`sorted()`](../library/functions.html#sorted "sorted") in combination with `set()` over a sequence is an idiomatic
